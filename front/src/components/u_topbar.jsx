  ...
  return (
    <div>
          ...
          <div className="staff-topbar-cont">
            ...
            <div className="right-tb">
              ...
              <div className="page-buttons-container">
                <Link to="/user_homepage" className="nav-linking-page">
                  <span className="homepage-btn">Home</span>
                </Link>
                <Link to="/user_records" className="nav-linking-page">
                  <span className="records-btn">Records</span>
                </Link>
                <Link to="/user_annolist" className="nav-linking-page">
                  <span className="records-btn">Announcements</span>
                </Link>
              </div>
      ...
      <div className={`mobile-menu ${isMobileMenuOpen ? "menu-open" : ""}`}>
        ...
        <Link to="/user_homepage" className="topbar-navigation">
          <span className="nav-text">Home</span>
        </Link>
        <Link to="/user_records" className="topbar-navigation">
          <span className="nav-text">Records</span>
        </Link>
        <Link to="/user_annolist" className="topbar-navigation">
            ...
            <div className="logout-modal-container">
              ...
              <div className="logout-selection-container">
                ...
                <div className="logout-linking-page">
                  <span
                    onClick={() => logOut(dispatch, profileObject.idNumber)}
