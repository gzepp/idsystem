        ...
        <div className="footer-wallpaper">
          <div className="footer-contents-container">
            ...
            <div className="footer-contents-2">
              ...
              <Link to="/user_homepage" className="logout-linking-page">
                <span className="footer-home-link">Home</span>
              </Link>
              <Link to="/user_annolist" className="logout-linking-page">
                <span className="footer-records-link">Announcements</span>
              </Link>
              <Link to="/user_records" className="logout-linking-page">
                <span className="footer-records-link">Records</span>
              </Link>
              <Link to="/user_profileupdate" className="logout-linking-page">
                <span className="footer-records-link">User Profile</span>
              </Link>
            </div>
