        ...
        <div className="footer-wallpaper">
          <div className="footer-contents-container">
            ...
            <div className="footer-contents-2">
              ...
              <Link to="/reg_homepage" className="logout-linking-page">
                <span className="footer-home-link">Home</span>
              </Link>
              <Link to="/reg_records" className="logout-linking-page">
                <span className="footer-records-link">Records</span>
              </Link>
              <Link to="/reg_reports" className="logout-linking-page">
                <span className="footer-records-link">Reports</span>
              </Link>
            </div>
