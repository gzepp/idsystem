...
import RegistrarReportList from "./admin_data/id_reportList";
...
export default function AdminReports() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const reqQrlist = { getAllReq: "approved" };
  ...
  //   {
  //     idNumber: "2020102397",
  //     reqFullname: "Aries Joson",
  //     description: "Processed",
  //     isArchive: "",
  //   },
  //   {
  //     idNumber: "2020104922",
  //     reqFullname: "Lara Lintao",
  //     description: "Validated",
  //     isArchive: "",
  //   },
  //   {
  //     idNumber: "2020102457",
  //     reqFullname: "Larry Gadon",
  //     description: "Pending",
  //     isArchive: "",
  //   },
  // ]);
  ...
  return (
    <div className="admin-u-regpage">
      ...
      <div className="admin-u-reg-contents">
        <AdminTopbar pageName="Lost ID Reports" />
