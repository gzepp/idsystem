...
import "./admin_css/admin_user_reg.css";
...
export default function AdminUReg() {
  ...
  return (
    <div className="admin-u-regpage">
      ...
      <div className="admin-u-reg-contents">
        <AdminTopbar pageName="Student Registration" />
        {/* loading overlay */}
        {loading && (
